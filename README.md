...
and Add your environment variables in this file:
```bash
# replace with actual mongo db url
DATABASE_URL=mongodb+srv://<username>:<password>@cluster0.mongodb.net/myFirstDatabase?Writes=true&w=majority
```
